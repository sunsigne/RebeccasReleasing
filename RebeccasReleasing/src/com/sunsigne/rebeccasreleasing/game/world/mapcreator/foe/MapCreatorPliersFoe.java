...
public class MapCreatorPliersFoe {
	...
	void createPliersFoe(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator, int x0,
			int y0) {
		createCyanPliersFoe(red, green, blue, handler_object, mapcreator, x0, y0);
		createGreenPliersFoe(red, green, blue, handler_object, mapcreator, x0, y0);
		createYellowPliersFoe(red, green, blue, handler_object, mapcreator, x0, y0);
		createOrangePliersFoe(red, green, blue, handler_object, mapcreator, x0, y0);
		createRedPliersFoe(red, green, blue, handler_object, mapcreator, x0, y0);
		createPurplePliersFoe(red, green, blue, handler_object, mapcreator, x0, y0);
	}

	private void createCyanPliersFoe(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator,
			int x0, int y0) {
	...
	private void createGreenPliersFoe(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator,
			int x0, int y0) {
	...
	private void createYellowPliersFoe(int red, int green, int blue, HandlerObject handler_object,
	...
	private void createOrangePliersFoe(int red, int green, int blue, HandlerObject handler_object,
			MapCreator mapcreator, int x0, int y0) {
	...
	private void createRedPliersFoe(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator,
			int x0, int y0) {
	...
	private void createPurplePliersFoe(int red, int green, int blue, HandlerObject handler_object,
			MapCreator mapcreator, int x0, int y0) {
