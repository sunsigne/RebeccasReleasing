...
public class MapCreatorGlassDesk {
	...
	void createGlassDesk(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator, int x0,
			int y0) {

		createCyanGlassDesk(red, green, blue, handler_object, mapcreator, x0, y0);
		createGreenGlassDesk(red, green, blue, handler_object, mapcreator, x0, y0);
		createYellowGlassDesk(red, green, blue, handler_object, mapcreator, x0, y0);
		createOrangeGlassDesk(red, green, blue, handler_object, mapcreator, x0, y0);
		createRedGlassDesk(red, green, blue, handler_object, mapcreator, x0, y0);
		createPurpleGlassDesk(red, green, blue, handler_object, mapcreator, x0, y0);
	}

	private void createCyanGlassDesk(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator,
			int x0, int y0) {
	...
	private void createGreenGlassDesk(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator,
			int x0, int y0) {
	...
	private void createYellowGlassDesk(int red, int green, int blue, HandlerObject handler_object,
	...
	private void createOrangeGlassDesk(int red, int green, int blue, HandlerObject handler_object,
			MapCreator mapcreator, int x0, int y0) {
	...
	private void createRedGlassDesk(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator,
			int x0, int y0) {
	...
	private void createPurpleGlassDesk(int red, int green, int blue, HandlerObject handler_object,
			MapCreator mapcreator, int x0, int y0) {
