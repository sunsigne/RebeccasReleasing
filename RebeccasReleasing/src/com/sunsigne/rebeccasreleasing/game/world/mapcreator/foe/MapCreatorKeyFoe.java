...
public class MapCreatorKeyFoe {
	...
	void createKeyFoe(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator, int x0,
			int y0) {
		createCyanKeyFoe(red, green, blue, handler_object, mapcreator, x0, y0);
		createGreenKeyFoe(red, green, blue, handler_object, mapcreator, x0, y0);
		createYellowKeyFoe(red, green, blue, handler_object, mapcreator, x0, y0);
		createOrangeKeyFoe(red, green, blue, handler_object, mapcreator, x0, y0);
		createRedKeyFoe(red, green, blue, handler_object, mapcreator, x0, y0);
		createPurpleKeyFoe(red, green, blue, handler_object, mapcreator, x0, y0);
	}

	private void createCyanKeyFoe(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator,
			int x0, int y0) {
	...
	private void createGreenKeyFoe(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator,
			int x0, int y0) {
	...
	private void createYellowKeyFoe(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator,
			int x0, int y0) {
	...
	private void createOrangeKeyFoe(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator,
			int x0, int y0) {
	...
	private void createRedKeyFoe(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator,
			int x0, int y0) {
	...
	private void createPurpleKeyFoe(int red, int green, int blue, HandlerObject handler_object, MapCreator mapcreator,
			int x0, int y0) {
